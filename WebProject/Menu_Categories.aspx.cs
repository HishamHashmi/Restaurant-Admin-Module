...
namespace Project_Stuff
{
    public partial class Menu_Categories : System.Web.UI.Page
    {
        ...
        private void BindData()
        {
            ...
            objCmd.CommandText = "SELECT * FROM menuCategories";
        ...
        protected void ButtonInsert_Click(object sender, EventArgs e)
        {
            if (UploadImage.HasFile)
            {
                ...
                SqlCommand cmd = new SqlCommand("insert into menuCategories(categoryName,categoryImage) values('" + TextBoxCategoryName.Text + "','" + imagePath + "')", con);
                con.Open();
                cmd.ExecuteNonQuery();
                con.Close();
